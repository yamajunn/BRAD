...
- 原木をクラフトテーブルの0番目スロットへ持って行く
    - 原木をクリックする
        - 原木の位置にカーソルを移動する
            - カーソルを原木の方向へ動かす
            - [原木とカーソルの座標が一致していることを認識する]
        - アイテムを持つ
            - 左クリックをする
            - [アイテムがスロットからカーソルに移動したことを認識する]
        - [原木を持っていることを認識する]
    - カーソルをクラフトテーブルの0番目スロットへ移動
        - カーソルをクラフトテーブルの0番目スロットの方向へ動かす
        - [クラフトテーブルの0番目スロットとカーソルの座標が一致していることを認識する]
    - アイテムを置く
        - 左クリックをする
        - アイテムが置かれたことを認識する
            - アイテムがカーソルからスロットへ移動したことを認識する
            - 原木がクラフトテーブルの0番目スロットに存在することを認識する
- クラフトされたアイテムをインベントリの0番目スロットへ移動
    - クラフトされたアイテムをクリックする
        - クラフト後のスロットにカーソルを合わせる
        - カーソルの位置がクラフトされたアイテムと一致していることを認識する
        - 左クリックをする
        - アイテムがスロットからカーソルに移動したことを認識する
    ...
    - アイテムを置く
        ...
        - アイテムが置かれたことを認識する
            - アイテムがスロットからカーソルに移動したことを認識する
            - アイテムがインベントリの0番目スロットに存在することを認識する
